...
import { IAbstractGraph as IGraph, ShapeStyle, Util, Matrix, IG6GraphEvent as GraphEvent } from '@antv/g6-core';
...
export default class ImageMiniMap extends Base {
  ...
  private updateViewport() {
    ...
    const graphMatrix = (graphGroup.getMatrix() || [1, 0, 0, 0, 1, 0, 0, 0, 1]) as mat3;
